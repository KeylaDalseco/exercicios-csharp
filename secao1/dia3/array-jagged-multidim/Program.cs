...
{
  public static void muldiDimArraysJagged()
  {
...
// EXEMPLOS DE MAIS DIMENSÕES COM ARRAY E COM O JAGGED
int[,,] multiDimensionalArray1 = new int[2, 3, 3]; // [[[1], [2], [3]]]
...
jaggedArray[0][1] = new int[4] { 1, 2, 3, 4 };
jaggedArray[0][2] = new int[4] { 1, 2, 3, 4 };
